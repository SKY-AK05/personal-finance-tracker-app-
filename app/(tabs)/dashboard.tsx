...
export default function DashboardScreen() {
  ...
  const [expenseData, setExpenseData] = useState({ daily: 0, credit: 0, special: 0 });
  ...
  const loadMonthlyData = useCallback(async () => {
    try {
      ...
      setExpenseData({ daily, credit, special });
    } catch (error) {
  ...
  const totalExpenses = expenseData.daily + expenseData.credit + expenseData.special;
